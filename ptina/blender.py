...
if 1:
    from ptina.tools import mtworker
...
class TinaRenderEngine(bpy.types.RenderEngine):
    ...
    def __on_update(self, depsgraph):
        ...
        from ptina.multimesh import compose_multiple_meshes
...
def register():
    ...
    bpy.types.Scene.tina_render = bpy.props.PointerProperty(name='ptina', type=TinaRenderProperties)
